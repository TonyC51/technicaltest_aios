...
public class RecipientController {
    ...
    @PostMapping("")
    public RecipientPayload createRecipient(@RequestBody RecipientPayload recipient) {
        return recipientService.createRecipient(recipient);
    }
    
    @PutMapping("")
    public RecipientPayload updateRecipient(@RequestBody RecipientPayload recipient) {
        return recipientService.updateRecipient(recipient);
    }
    
    @GetMapping(ApiUrl.BY_ID)
    public RecipientPayload getRecipientById(@PathVariable Long id) {
